 ...
 */
public class stuffsearch extends javax.swing.JFrame {
Connection conn = null;
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try{
           // String name = jTextField3.getText();
            String id = jTextField2.getText();
            stmt=conn.createStatement();
           // String sql="Select * From staff where staffid='"+id+"' && name='"+name+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stuffsearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
